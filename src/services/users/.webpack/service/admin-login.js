...
/******/ 	return __webpack_require__(__webpack_require__.s = "./admin-login.ts");
/******/ })
/************************************************************************/
/******/ ({
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"handler\", function() { return handler; });\n/* harmony import */ var source_map_support_register__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! source-map-support/register */ \"source-map-support/register\");\n/* harmony import */ var source_map_support_register__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(source_map_support_register__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _hapi_joi__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @hapi/joi */ \"@hapi/joi\");\n/* harmony import */ var _hapi_joi__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_hapi_joi__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var bcryptjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! bcryptjs */ \"bcryptjs\");\n/* harmony import */ var bcryptjs__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(bcryptjs__WEBPACK_IMPORTED_MODULE_2__);\n/* harmony import */ var _utils_errors__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../utils/errors */ \"../../utils/errors.ts\");\n/* harmony import */ var _utils_db__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../utils/db */ \"../../utils/db.ts\");\n/* harmony import */ var _utils_auth__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../utils/auth */ \"../../utils/auth.ts\");\n/* harmony import */ var _models_Admin__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../models/Admin */ \"../../models/Admin.ts\");\n\n\n\n\n\n\n\nconst validationSchema = _hapi_joi__WEBPACK_IMPORTED_MODULE_1___default.a.object({\n    email: _hapi_joi__WEBPACK_IMPORTED_MODULE_1___default.a.string()\n        .email({ minDomainSegments: 2, tlds: { allow: ['fi'] } })\n        .regex(/3as.fi/)\n        .required(),\n    password: _hapi_joi__WEBPACK_IMPORTED_MODULE_1___default.a.string()\n        .min(4)\n        .required(),\n});\nconst url = process.env.MONGO_URL;\nconst handler = async (event, context) => {\n    context.callbackWaitsForEmptyEventLoop = false;\n    try {\n        const parsedBody = JSON.parse(event.body);\n        await validationSchema.validateAsync(parsedBody);\n        const { password, email } = parsedBody;\n        await Object(_utils_db__WEBPACK_IMPORTED_MODULE_4__[\"connectToDataBase\"])(url);\n        const admin = await _models_Admin__WEBPACK_IMPORTED_MODULE_6__[\"default\"].findOne({ email });\n        if (!admin) {\n            return Object(_utils_errors__WEBPACK_IMPORTED_MODULE_3__[\"createError\"])({\n                message: 'Authentication failed',\n                altStatusCode: 400,\n                name: 'BadRequest',\n            });\n        }\n        const isValid = await bcryptjs__WEBPACK_IMPORTED_MODULE_2___default.a.compare(password, admin.password);\n        if (!isValid) {\n            return Object(_utils_errors__WEBPACK_IMPORTED_MODULE_3__[\"createError\"])({\n                message: 'authentication failed',\n                altStatusCode: 400,\n                name: 'BadRequest',\n            });\n        }\n        const generationData = {\n            _id: admin._id,\n            email,\n        };\n        const token = Object(_utils_auth__WEBPACK_IMPORTED_MODULE_5__[\"generateAdminJWT\"])(generationData);\n        return {\n            statusCode: 200,\n            headers: Object.assign({}, _utils_db__WEBPACK_IMPORTED_MODULE_4__[\"corsHeaders\"]),\n            body: JSON.stringify({\n                message: 'Login Successful',\n                token,\n            }),\n        };\n    }\n    catch (e) {\n        return Object(_utils_errors__WEBPACK_IMPORTED_MODULE_3__[\"createError\"])({ e });\n    }\n};\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///./admin-login.ts\n");
